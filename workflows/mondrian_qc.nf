...
human_reference_version = val(params.human_reference_version)
mouse_reference = file(params.mouse_reference)
mouse_reference_version = val(params.mouse_reference_version)
salmon_reference = file(params.salmon_reference)
salmon_reference_version = val(params.salmon_reference_version)
